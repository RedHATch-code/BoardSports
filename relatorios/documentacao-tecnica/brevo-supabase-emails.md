...
Set the Brevo SMTP values above. Also confirm the URL Configuration includes the production Netlify URL and the auth redirect pages used by the app:

```text
https://wondrous-choux-fb5a96.netlify.app
https://wondrous-choux-fb5a96.netlify.app/verify-email.html
https://wondrous-choux-fb5a96.netlify.app/reset-password.html
https://boardsports.netlify.app
https://boardsports.netlify.app/verify-email.html
https://boardsports.netlify.app/reset-password.html
http://127.0.0.1:3000
http://127.0.0.1:3000/verify-email.html
