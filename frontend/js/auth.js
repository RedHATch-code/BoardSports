...
forgotPasswordButton?.addEventListener('click', async () => {
  ...
  if (!email) {
    mostrarMensagem('Indica primeiro o email para receberes o link de recuperação.', 'error')
    emailInput.focus()
    return
  }
  ...
  if (resultado.sucesso) {
    mostrarMensagem('Pedido enviado. Se existir uma conta com esse email, vais receber o link de recuperação.', 'success')
  } else {
    mostrarMensagem(`Falha na recuperação: ${resultado.erro}`, 'error')
  }
